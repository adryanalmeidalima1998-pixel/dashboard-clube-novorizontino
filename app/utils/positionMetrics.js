  ...
  EXTREMO: {
    ...
    radarMetrics: [
      ...
      },
      {
        ...
        key: 'Dribles no último terço do campo com sucesso',
        type: 'per90',
        max: 4,
    ...
    scatterPlots: [
      {
        ...
        xKey: 'Dribles bem sucedidos',
        yKey: 'Dribles no último terço do campo com sucesso',
        xType: 'per90',
        yType: 'per90',
