...
export const POSITION_METRICS = {
  ...
  ZAGUEIRO: {
    ...
    radarMetrics: [
      ...
      { label: 'Duelos Aéreos/90', key: 'Disputas aéreas', type: 'per90', max: 6 },
      { label: 'Desarmes/90', key: 'Desarmes com sucesso', type: 'per90', max: 5 },
      ...
      { label: 'Passes Longos/90', key: 'Passes longos', type: 'per90', max: 6 },
      { label: 'xG/90', key: 'Xg', type: 'per90', max: 0.15 },
      { label: 'Ações Área Adv./90', key: 'Ações na área adversária bem-sucedidas', type: 'per90', max: 2 },
    ],
    scatterPlots: [
      { id: 'zag-fisico', titulo: 'Dominância Física', subtitulo: 'Desafios vencidos/90 × Duelos aéreos vencidos/90', xLabel: 'Desafios Vencidos/90', yLabel: 'Duelos Aéreos/90', xKey: 'Desafios vencidos', yKey: 'Duelos aéreos vencidos', xType: 'per90', yType: 'per90' },
